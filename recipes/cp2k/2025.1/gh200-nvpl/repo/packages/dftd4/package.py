...
class Dftd4(MesonPackage, CMakePackage):
    ...
    version(
        "3.4.0",
        sha256="24fcb225cdd5c292ac26f7d3204ee3c4024174adb5272eeda9ae7bc57113ec8d",
    )
    version(
        "3.3.0",
        sha256="408720b8545532d5240dd743c05d57b140af983192dad6d965b0d79393d0a9ef",
    )
    version(
        "3.2.0",
        sha256="cef505e091469aa9b8f008ee1756545bb87b02760bb2c7ca54854e20ba8c590a",
    )
    version(
        "3.1.0",
        sha256="b652aa7cbf8d087c91bcf80f2d5801459ecf89c5d4176ebb39e963ee740ed54b",
    )
    version(
        "3.0.0",
        sha256="a7539d68d48d851bf37b79e37ea907c9da5eee908d0aa58a0a7dc15f04f8bc35",
    )
    ...
    depends_on(
        "meson@0.57.1:", type="build", when="build_system=meson"
    )  # mesonbuild/meson#8377
    ...
    for build_system in ["cmake", "meson"]:
        depends_on(
            f"mctc-lib build_system={build_system}", when=f"build_system={build_system}"
        )
        depends_on(
            f"multicharge build_system={build_system}",
            when=f"build_system={build_system}",
        )
